...
vector<string> 特效选择检查 = { "特效选择", "", "秘术·天元", "秘术·加攻","秘术·加防","秘术·加血","秘术·加暴","秘术·眩晕","法宝·无视","灵核·青魔","灵核·青龙","灵核·墨魂","灵核·死狱","灵核·灭魂","灵核·白虹","灵核·太荒","灵核·九阳","灵核·天问","灵核·蚀天" };
...
void Unit::使用() {
	...
	else if (特效类型 == "灵核·九阳") 敌人->AddBuff(血, -特效参数 * 主人->攻击, 0);
